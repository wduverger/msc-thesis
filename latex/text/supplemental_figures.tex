...
\begin{figure}[ht]
	...
	\caption{
		The power of each of the three lasers as measured through a 10x objective. Notice the non-linearity at low power settings. The 775 nm data was scaled down by three orders of magnitude. \todo{reference to figure}
	}
...
\begin{figure}
	...
	\caption{
		Depletion PSF as a function of beam polarisation. \question{Why the change in background levels?}
	}
